...
describe('This is first test suite, Lii Saluvere', () => {
    it('User can submit data only when valid mandatory values are added', () => {
        //changes made 31.01.2024
        cy.get('[data-testid="phoneNumberTestId"]').type('555666777')
        cy.get('#firstName').type('Cerebrum')
        cy.get('#lastName').type('Hub')
        cy.get('input[name="password"]').type('Pass456')
        cy.get('[name="confirm"]').type('Pass456')
